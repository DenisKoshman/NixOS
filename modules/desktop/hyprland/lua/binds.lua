...
hl.bind(
	"CONTROL + ESCAPE",
	hl.dsp.exec_cmd('pkill "xar|hyprpanel|wayle|noctalia-shell|caelestia-shell|.quickshell" || ' .. bar)
) -- toggle bar
...
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd("google-chrome")) -- web browser
...
-- Window manager
hl.bind(mainMod .. " + D", hl.dsp.exec_cmd(launcher .. " drun")) -- launch desktop applications
